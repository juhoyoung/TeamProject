...
<div class="w3-top">
 ...
 <div id = "icon">
  ...
  <a href="multiChat" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white" title="MultiChatting"><i class="fa fa-user" style="color:#A0EEEE"></i></a>
...
<div class="w3-dropdown-hover w3-hide-small">
    <button class="w3-button w3-padding-large" title="Notifications"><i class="fa fa-bell" style="color:#A3B4FD"></i><span class="w3-badge w3-right w3-small w3-green">3</span></button>     
